...
def load_model(engine='ws1000', model_name='model/tokenizer.model'):
    '''
    ...
    if engine != 'deepcut':
        if 'tl-deepcut' in engine:
            ...
            try:
                ...
                # fn = f'C:/Users/natch/Github/NLP_Project/NLP_project/Jearn/SEFR_CUT-0.2/sefr_cut/model/my_model.model'
                model_load.open(os.path.join(PATH,model_name))
            except:
                raise Exception(f'Engine available: ws1000,tnhc,best. {engine} is not available! WOOO')
